 ...
 * @see  SOFTAP_enable()
 */
int softap_get_subnet_mask(softap_h softap, softap_type_e type, softap_address_family_e address_family, char **subnet_mask);
 ...
 * @see  softap_enable()
 */
int softap_foreach_connected_clients(softap_h softap, softap_type_e type, softap_connected_client_cb callback, void *user_data);
